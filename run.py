...
CUTS = {
    ...
    "1": {"start": 0, "end": 408, "label": "カット1（シーン1-4）"},  # 【改訂】576→408 (-168)
    "2": {"start": 408, "end": 744, "label": "カット2（シーン5-7）"},  # 【改訂】576→408 start、912→744 end
    "3": {"start": 744, "end": 960, "label": "カット3（シーン8-9）"},  # 【改訂】912→744 start、1128→960 end
